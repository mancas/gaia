...
(function(exports) {
  ...
  var DetailsUI = {
    ...
    toggleFavorite: function() {
      ...
      Details.toggleFavorite(contact);
    },
    ...
    renderDuplicate: function(contact) {
      ...
      window.addEventListener('getcountdone', function fn(evt) {
        window.removeEventListener('getcountdone', fn);

        var count = evt.detail;
        if (count > 1) {
