  ...
  suite('initiation', function() {
    ...
    test('we should observe settings', function() {
      ...
      assert.ok(SettingsListener.observe.calledWith(
        hotspot.tetheringWifiKey, true, hotspot.handleHotspotSettingChange),
        'should observe hotspot wifi setting');
      assert.ok(SettingsListener.observe.calledWith(
        hotspot.tetheringUsbKey, true, hotspot.handleUsbHotspotSettingChange),
        'should observe hotspot usb setting');
      assert.ok(SettingsListener.observe.calledWith(
        hotspot.usbStorageKey, true, hotspot.handleUsbStorageSettingChange),
